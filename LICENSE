...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $em_operacao = $_POST["em_operacao"];
  $nivel_tensao = $_POST["nivel_tensao"];
  $status = $_POST["status"];
...
$conn = new mysqli($servername, $username, $password, $dbname);
  ...
  $sql = "INSERT INTO tabela (ID, numero_serie, fabricante, tipo_equipamento, subestacao, data_entrada, em_operacao, nivel_tensao, status, observacoes) 
          VALUES ('$ID', '$numero_serie', '$fabricante', '$tipo_equipamento', '$subestacao', '$data_entrada', '$em_operacao', '$nivel_tensao', '$status', '$observacoes')";
